      ...
      <CardHeader className="pb-3 flex-shrink-0">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => toast.info(`${messages.length} mensagens nesta sessão`, { description: "Clique no ícone de download para exportar o histórico completo.", duration: 4000 })}>
