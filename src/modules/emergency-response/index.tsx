  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">Preparedness</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Emergency response coordination system with automated alerts, contact management, 
            drill scheduling, and real-time incident tracking.
          </p>
        </CardContent>
      </Card>
    </div>
