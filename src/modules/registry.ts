...
export const MODULE_REGISTRY: Record<string, ModuleDefinition> = {
  ...
  // PATCH FASE 2.5 - ROTAS ÓRFÃS CORRIGIDAS (2024-12-11)
  // Rotas adicionadas para páginas principais que estavam sem registro
  ...
  "core.dashboard": {
    ...
    description: "Dashboard principal do sistema com visão geral de operações",
    status: "active",
    completeness: "100%",
    route: "/dashboard",
    icon: "LayoutDashboard",
  ...
  "config.settings": {
    ...
    category: "configuration",
    path: "pages/Settings",
    description: "Configurações gerais do sistema, perfil e preferências",
    status: "active",
    completeness: "100%",
    route: "/settings",
    icon: "Settings",
  ...
  "config.admin": {
    ...
    category: "configuration",
    path: "pages/Admin",
    description: "Painel administrativo - gestão de usuários, permissões e sistema",
    status: "active",
    completeness: "100%",
    route: "/admin",
    icon: "Shield",
  ...
  "intelligence.ai-enhanced-modules": {
    id: "intelligence.ai-enhanced-modules",
    name: "Módulos Aprimorados com IA",
    category: "intelligence",
    path: "pages/AIEnhancedModules",
    description: "Catálogo de módulos com aprimoramentos de IA",
    status: "active",
    completeness: "100%",
    route: "/ai-enhanced-modules",
    icon: "Sparkles",
    lazy: true,
    version: "2.5.0",
  },
  ...
  "intelligence.ai-modules-status": {
    id: "intelligence.ai-modules-status",
    name: "Status de Módulos IA",
    category: "intelligence",
    path: "pages/AIModulesStatus",
    description: "Dashboard de status e métricas dos módulos de IA",
    status: "active",
    completeness: "100%",
    route: "/ai-modules-status",
    icon: "Activity",
    lazy: true,
    version: "2.5.0",
  },
  ...
  "hr.ai-training": {
    ...
    category: "hr",
    path: "pages/AITraining",
    description: "Gestão de treinamento e evolução dos modelos de IA",
    status: "active",
    completeness: "100%",
    route: "/ai-training",
    icon: "GraduationCap",
  ...
  "planning.business-continuity": {
    id: "planning.business-continuity",
    name: "Plano de Continuidade",
    category: "planning",
    path: "pages/BusinessContinuityPlan",
    description: "Plano de continuidade de negócios e gestão de crises",
    status: "active",
    completeness: "100%",
  ...
  "features.experimental": {
    id: "features.experimental",
    name: "Módulos Experimentais",
    category: "features",
    path: "pages/ExperimentalModules",
    description: "Funcionalidades experimentais em desenvolvimento",
    status: "beta",
    completeness: "partial",
    route: "/experimental",
    icon: "Beaker",
    lazy: true,
    permissions: ["admin", "beta-tester"],
    version: "2.5.0",
  },

  "operations.fleet-management": {
    id: "operations.fleet-management",
    name: "Gestão de Frota",
    category: "operations",
    path: "pages/FleetManagement",
    description: "Gestão completa de frota naval - status, localização e métricas",
    status: "active",
    completeness: "100%",
  ...
  "planning.forecast": {
    ...
    category: "planning",
    path: "pages/Forecast",
    description: "Sistema de previsões operacionais e meteorológicas",
    status: "active",
    completeness: "100%",
    route: "/forecast",
    icon: "CloudRain",
