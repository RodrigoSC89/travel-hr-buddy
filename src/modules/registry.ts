...
export const MODULE_REGISTRY: Record<string, ModuleDefinition> = {
  ...
  "training.solas-isps-training": {
    ...
    category: "hr",
    path: "modules/solas-isps-training",
  ...
  "features.task-automation": {
    ...
    description: "Automated task management with AI-powered workflows",
    status: "active",
    completeness: "100%",
  ...
  "features.project-timeline": {
    ...
    description: "Project timeline management with Gantt charts and dependencies",
    status: "active",
    completeness: "100%",
  ...
  "logistics.autonomous-procurement": {
    ...
    category: "logistics",
    path: "modules/autonomous-procurement",
  ...
  "hr.medical-infirmary": {
    ...
    category: "hr",
    path: "modules/medical-infirmary",
  ...
  "operations.cargo-management": {
    id: "operations.cargo-management",
    name: "Cargo Management",
    category: "operations",
    path: "pages/CargoManagementPage",
    description: "Planejamento de carga/descarga, containers, tracking e otimização de espaço com IA",
    status: "active",
    completeness: "100%",
    route: "/cargo-management",
    icon: "Ship",
    lazy: true,
    version: "900.0",
  },

  "operations.charter-party": {
    id: "operations.charter-party",
    name: "Charter Party Management",
    category: "operations",
    path: "pages/CharterPartyPage",
    description: "Gestão de contratos de afretamento, cálculo de hire/demurrage, performance clauses",
    status: "active",
    completeness: "100%",
    route: "/charter-party",
    icon: "FileText",
  ...
  "operations.port-call": {
    id: "operations.port-call",
    name: "Port Call Optimization",
    category: "operations",
    path: "pages/PortCallOptimizationPage",
    description: "Planejamento de chegada/saída, documentação, previsão de fila e custos portuários",
    status: "active",
    completeness: "100%",
    route: "/port-call-optimization",
    icon: "Anchor",
    lazy: true,
    version: "900.0",
  },

  "finance.voyage-accounting": {
    id: "finance.voyage-accounting",
    name: "Voyage Accounting",
    category: "finance",
    path: "pages/VoyageAccountingPage",
    description: "P&L por viagem, TCE, budget vs actual, análise de rentabilidade com IA",
    status: "active",
    completeness: "100%",
    route: "/voyage-accounting",
    icon: "DollarSign",
    lazy: true,
    version: "900.0",
  },
  ...
  // Q1 2025 - Quick Wins
  "core.export-center": {
    id: "core.export-center",
    name: "Centro de Exportação",
    category: "core",
    path: "pages/ExportCenterPage",
    description: "Exportação multi-formato: PDF, Excel, CSV, JSON com templates",
    status: "active",
    completeness: "100%",
    route: "/export-center",
    icon: "Download",
  ...
  "core.advanced-search": {
    id: "core.advanced-search",
    name: "Busca Avançada",
    category: "core",
    path: "pages/AdvancedSearchPage",
    description: "Busca global inteligente com IA, filtros semânticos e sugestões",
    status: "active",
    completeness: "100%",
  ...
  "compliance.isps-security": {
    id: "compliance.isps-security",
    name: "ISPS Security & Cyber",
    category: "compliance",
    path: "pages/ISPSPage",
    description: "ISPS Code compliance, Ship Security Plan, Maritime Cybersecurity",
    status: "active",
    completeness: "100%",
    route: "/isps-security",
    icon: "Shield",
  ...
  "compliance.drill-simulator": {
    id: "compliance.drill-simulator",
    name: "Drill Simulator",
    category: "compliance",
    path: "pages/DrillSimulatorPage",
    description: "Simulação de emergências: incêndio, abandono, MOB, vazamento com avaliação IA",
    status: "active",
    completeness: "100%",
    route: "/drill-simulator",
    icon: "Target",
    lazy: true,
    version: "900.0",
  },

  "operations.sustainability-score": {
    id: "operations.sustainability-score",
    name: "Sustainability Score",
    category: "operations",
    path: "pages/SustainabilityScorePage",
    description: "Score ESG consolidado (0-100), ranking de embarcações, benchmarking",
    status: "active",
    completeness: "100%",
