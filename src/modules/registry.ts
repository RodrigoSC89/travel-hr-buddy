...
'documents.hub': {
    ...
    description: 'Unified document management with AI analysis, upload, preview, and Supabase integration',
    status: 'active',
...
'documents.ai': {
    id: 'documents.ai',
    name: 'AI Documents (Legacy)',
    category: 'documents',
    path: 'modules/documents/documents-ai/DocumentsAI',
    description: 'Legacy AI-powered document management - moved to Document Hub',
    status: 'deprecated',
    route: '/documents',
    icon: 'FileText',
    lazy: true,
...
'documents.templates': {
    ...
    description: 'Document templates - moved to Document Hub',
    status: 'deprecated',
    route: '/templates',
    icon: 'FileCode',
    lazy: true,
