...
export const MODULE_REGISTRY: Record<string, ModuleDefinition> = {
  ...
  'operations.crew-wellbeing': {
    ...
    status: 'active',
    route: '/operations/crew-wellbeing',
    icon: 'Heart',
    lazy: true,
  },
  ...
  'connectivity.notifications': {
    ...
    status: 'active',
    route: '/connectivity/notifications',
    icon: 'Bell',
    lazy: true,
  },
  ...
  'documents.ai': {
    ...
    name: 'AI Documents',
    category: 'documents',
    path: 'modules/documentos-ia/DocumentsAI',
  ...
  'features.price-alerts': {
    ...
    name: 'Price Alerts',
    category: 'features',
    path: 'modules/alertas-precos',
    description: 'Price monitoring and alerts',
    status: 'active',
    route: '/features/price-alerts',
    icon: 'Bell',
    lazy: true,
  },

  'features.smart-checklists': {
    id: 'features.smart-checklists',
    name: 'Smart Checklists',
    category: 'features',
    path: 'modules/checklists-inteligentes',
