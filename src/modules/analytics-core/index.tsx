      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Custom views</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Live data feeds</p>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Core analytics engine with data processing, visualization, real-time streaming, 
            and custom dashboard builder for comprehensive business intelligence.
          </p>
        </CardContent>
      </Card>
    </div>
