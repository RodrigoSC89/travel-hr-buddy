  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">Searchable Docs</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            AI-powered document processing with OCR, intelligent classification, 
            content extraction, and automated data entry from scanned documents.
          </p>
        </CardContent>
      </Card>
    </div>
...
export default DocumentAIModule;
