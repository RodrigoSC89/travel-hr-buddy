...
| ID | Name | Status | Route |
|----|------|--------|-------|
| compliance.hub | Compliance Hub | ✅ Active | /compliance-hub |
...
| ID | Name | Status | Route |
|----|------|--------|-------|
| connectivity.channel-manager | Channel Manager | ✅ Active | /channel-manager |
| connectivity.api-gateway | API Gateway | ✅ Active | /api-gateway |
...
```typescript
import { MODULE_REGISTRY, getModule, getActiveModules } from '@/modules/registry';
...
// Get all active modules with routes
...
3. Add route in App.tsx or via module-routes helper
