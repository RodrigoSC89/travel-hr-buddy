/**
 * Planejador de Manutenção Inteligente
 * Módulo unificado que combina as funcionalidades do Maintenance Planner e MMI
 * 
 * Features:
...
import { 
  ...
  Zap, Shield, Search, Filter, RefreshCw
} from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { useNavigate } from "react-router-dom";

// Existing components from maintenance-planner
...
import MMIForecastSection from "./components/MMIForecastSection";
import MMIHistorySection from "./components/MMIHistorySection";
import MMIJobsPanelSection from "./components/MMIJobsPanelSection";
import MMIDashboardSection from "./components/MMIDashboardSection";
...
const IntelligentMaintenancePlanner = () => {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Sistema Premium de Gestão de Manutenção Naval com IA</p>
          </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="overview" className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-orange-300" onClick={() => setActiveTab("saude")}>
              <CardHeader>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-indigo-300" onClick={() => setActiveTab("dashboard")}>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-teal-300" onClick={() => setActiveTab("horimetros")}>
              <CardHeader>
                ...
                <CardDescription>
                  Gestão de horímetros e controle de horas
                </CardDescription>
              </CardHeader>
              <CardContent>
...
export default IntelligentMaintenancePlanner;
