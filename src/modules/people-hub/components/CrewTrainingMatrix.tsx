  ...
  useEffect(() => {
    async function loadFromSupabase() {
      ...
      if (members && members.length > 0) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any -- crew_members joined query with dynamic nested columns (.vessels.name)
      ...
      if (certs && certs.length > 0) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any -- certifications dynamic schema with nested property access
