...
// Lazy load all pages using safeLazyImport for robust error handling
...
const AdminChecklistsDashboard = safeLazyImport(() => import("./pages/admin/checklists-dashboard"), "Admin Checklists Dashboard");
...
const DocumentAIEditor = safeLazyImport(() => import("./pages/admin/documents/ai-editor"), "Document AI Editor");
...
const MetricasRisco = safeLazyImport(() => import("./pages/admin/metricas-risco"), "Metricas Risco");
const AdminSGSO = safeLazyImport(() => import("./pages/admin/sgso"), "Admin SGSO");
const SGSOHistoryPage = safeLazyImport(() => import("./pages/admin/sgso/history/[vesselId]"), "SGSO History");
