...
const DocumentList = React.lazy(() => import("./pages/admin/DocumentList"));
const DocumentView = React.lazy(() => import("./pages/admin/DocumentView"));
const DocumentCreate = React.lazy(() => import("./pages/admin/DocumentCreate"));
                ...
                <React.Suspense fallback={<LoadingSpinner />}>
                  <Routes>
                    ...
                    <Route element={<SmartLayout />}>
                      ...
                      <Route path="/admin/documents/create" element={<DocumentCreate />} />
