...
export const AppRoutes = () => (
  <Routes>
    ...
    <Route element={<ProtectedRoute><AuthenticatedLayout /></ProtectedRoute>}>
      ...
      <Route path="/world-leadership" element={<Pages.WorldLeadershipDashboard />} />
      <Route path="/commercial-ops" element={<Pages.CommercialOperationsHub />} />
      ...
      <Route path="/freight-invoicing" element={<Pages.FreightInvoicePage />} />
      <Route path="/voyage-estimate" element={<Pages.VoyageEstimatePage />} />
      <Route path="/crew-payroll" element={<Pages.CrewPayrollPage />} />
      <Route path="/budget-opex" element={<Pages.BudgetOpexPage />} />
      <Route path="/regulatory-radar" element={<Pages.RegulatoryRadarPage />} />
      <Route path="/warranty-claims" element={<Pages.WarrantyClaimsPage />} />
      <Route path="/spare-parts" element={<Pages.SparePartsPage />} />
      <Route path="/pms-hub" element={<Pages.PMSHubPage />} />
      ...
      <Route path="/consolidation-plan" element={<Pages.ModuleConsolidationPlan />} />
      <Route path="/module-consolidation" element={<Pages.ModuleConsolidationPlan />} />
