...
import DocumentViewGeneralPage from "@/pages/admin/documents/DocumentViewGeneral";
...
describe("DocumentViewGeneralPage Component", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("should render loading state initially", () => {
    ...
    render(
      <MemoryRouter initialEntries={["/admin/documents/general/123"]}>
        <Routes>
          <Route path="/admin/documents/general/:id" element={<DocumentViewGeneralPage />} />
        </Routes>
      </MemoryRouter>
    );
  ...
  it("should render document details when found", async () => {
    ...
    render(
      <MemoryRouter initialEntries={["/admin/documents/general/doc-1"]}>
        <Routes>
          <Route path="/admin/documents/general/:id" element={<DocumentViewGeneralPage />} />
        </Routes>
      </MemoryRouter>
  ...
  it("should handle document with no content", async () => {
    ...
    render(
      <MemoryRouter initialEntries={["/admin/documents/general/doc-2"]}>
        <Routes>
          <Route path="/admin/documents/general/:id" element={<DocumentViewGeneralPage />} />
        </Routes>
      </MemoryRouter>
