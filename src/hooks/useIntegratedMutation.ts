...
const CROSS_MODULE_INVALIDATIONS: Partial<Record<EventType, string[][]>> = {
  ...
  'maintenance.work_order.created': [['maintenance'], ['work-orders'], ['fleet'], ['compliance'], ['dashboard-kpis']],
  'maintenance.work_order.completed': [['maintenance'], ['work-orders'], ['compliance'], ['procurement'], ['dashboard-kpis']],
