  ...
  // ═══════════════════════════════════════════
  {
    ...
    handler: (event, qc) => {
      toast.info("Viagem Criada", {
        ...
        action: { label: "Ver Viagens", onClick: () => spaNavigate('/ops') },
      });
  ...
  },
  {
    ...
    handler: (_e, qc) => {
      toast.success("Viagem Concluída", {
        ...
        action: { label: "Ver P&L", onClick: () => spaNavigate('/voyage-pnl') },
      });
      qc.invalidateQueries({ queryKey: ['voyages'] });
  ...
  },
  {
    ...
    handler: (_e, qc) => {
      toast.info("Nova Sugestão IA", {
        ...
        action: { label: "Ver IA", onClick: () => spaNavigate('/ai') },
      });
...
const UNIVERSAL_INVALIDATION_MAP: Record<string, string[][]> = {
  ...
  'compliance.nc.created': [['non-conformities'], ['compliance'], ['findings'], ['risk'], ['safety'], ['dashboard-kpis']],
  'compliance.nc.status_changed': [['non-conformities'], ['compliance'], ['findings'], ['risk'], ['safety'], ['dashboard-kpis']],
  'compliance.internal_audit.created': [['internal-audits'], ['audits'], ['compliance'], ['dashboard-kpis']],
  'compliance.internal_audit.completed': [['internal-audits'], ['audits'], ['compliance'], ['certificates'], ['dashboard-kpis']],
  'operations.checklist.created': [['checklists'], ['compliance'], ['safety'], ['dashboard-kpis']],
  'operations.checklist.completed': [['checklists'], ['compliance'], ['safety'], ['dashboard-kpis']],
  'safety.drill.created': [['drills'], ['safety'], ['compliance'], ['crew'], ['dashboard-kpis']],
  'safety.drill.completed': [['drills'], ['safety'], ['compliance'], ['crew'], ['training'], ['dashboard-kpis']],
  'safety.incident.created': [['incidents'], ['safety'], ['compliance'], ['risk'], ['alerts'], ['dashboard-kpis']],
  'safety.incident.updated': [['incidents'], ['safety'], ['compliance'], ['risk'], ['dashboard-kpis']],
  'safety.near_miss.created': [['near-misses'], ['safety'], ['compliance'], ['risk'], ['dashboard-kpis']],
  'finance.expense.created': [['expenses'], ['finance'], ['voyage-pnl'], ['budgets'], ['dashboard-kpis']],
  'finance.expense.updated': [['expenses'], ['finance'], ['voyage-pnl'], ['budgets'], ['dashboard-kpis']],
  'finance.transaction.created': [['financial-transactions'], ['finance'], ['dashboard-kpis']],
  'finance.budget.created': [['budgets'], ['finance'], ['dashboard-kpis']],
  'finance.budget.updated': [['budgets'], ['finance'], ['expenses'], ['dashboard-kpis']],
  'finance.payroll.created': [['payroll'], ['crew'], ['finance'], ['expenses'], ['dashboard-kpis']],
  'people.leave.requested': [['leave-requests'], ['crew'], ['rotations'], ['dashboard-kpis']],
  'people.leave.approved': [['leave-requests'], ['crew'], ['rotations'], ['vessels'], ['dashboard-kpis']],
  'people.evaluation.created': [['evaluations'], ['crew'], ['training'], ['dashboard-kpis']],
  'people.wellness.updated': [['wellness'], ['crew'], ['medical'], ['dashboard-kpis']],
  'people.climate.response': [['climate-survey'], ['crew'], ['dashboard-kpis']],
  'people.onboarding.started': [['onboarding'], ['crew'], ['training'], ['compliance'], ['dashboard-kpis']],
  'procurement.supplier.created': [['suppliers'], ['procurement'], ['finance'], ['dashboard-kpis']],
  'procurement.supplier.updated': [['suppliers'], ['procurement'], ['finance']],
  'procurement.order.received': [['procurement'], ['inventory'], ['maintenance'], ['finance'], ['dashboard-kpis']],
  'operations.cargo.created': [['cargo'], ['voyages'], ['fleet'], ['finance'], ['dashboard-kpis']],
  'operations.cargo.updated': [['cargo'], ['voyages'], ['fleet'], ['finance'], ['dashboard-kpis']],
  'operations.bunker.created': [['bunker-operations'], ['fleet'], ['finance'], ['environmental'], ['dashboard-kpis']],
  'operations.ballast.created': [['ballast-water'], ['compliance'], ['environmental'], ['dashboard-kpis']],
  'comms.message.sent': [['channel-messages'], ['crew'], ['alerts']],
  'comms.notification.created': [['system-notifications'], ['alerts']],
  'maintenance.record.created': [['maintenance-records'], ['maintenance'], ['compliance'], ['fleet'], ['dashboard-kpis']],
  'maintenance.record.updated': [['maintenance-records'], ['maintenance'], ['compliance'], ['fleet'], ['dashboard-kpis']],
  'maintenance.drydock.created': [['drydock'], ['maintenance'], ['fleet'], ['finance'], ['dashboard-kpis']],
  'maintenance.drydock.updated': [['drydock'], ['maintenance'], ['fleet'], ['finance'], ['dashboard-kpis']],
  'maintenance.defect.created': [['defects'], ['maintenance'], ['compliance'], ['fleet'], ['dashboard-kpis']],
  'maintenance.warranty.created': [['warranty'], ['maintenance'], ['finance'], ['suppliers'], ['dashboard-kpis']],
  'analytics.report.generated': [['analytics-reports'], ['ai-reports'], ['dashboard-kpis']],
  'analytics.dashboard.updated': [['analytics-dashboards'], ['dashboard-kpis']],
  'automation.workflow.created': [['automation-workflows'], ['dashboard-kpis']],
  'automation.workflow.executed': [['automation-workflows'], ['automation-executions'], ['dashboard-kpis']],
  'medical.record.created': [['medical'], ['medical-records'], ['crew'], ['compliance'], ['dashboard-kpis']],
  'medical.record.updated': [['medical'], ['medical-records'], ['crew'], ['compliance'], ['dashboard-kpis']],
  'calendar.event.created': [['calendar-events'], ['crew'], ['dashboard-kpis']],
  'calendar.event.updated': [['calendar-events'], ['crew']],
  'compliance.sgso.plan_created': [['sgso-plans'], ['compliance'], ['safety'], ['dashboard-kpis']],
  'compliance.sgso.plan_updated': [['sgso-plans'], ['compliance'], ['safety'], ['dashboard-kpis']],
  'environmental.emissions.created': [['emissions'], ['environmental'], ['compliance'], ['fleet'], ['dashboard-kpis']],
  'environmental.emissions.updated': [['emissions'], ['environmental'], ['compliance'], ['fleet'], ['dashboard-kpis']],
  'compliance.preovid.created': [['preovid-audits'], ['compliance'], ['audits'], ['dashboard-kpis']],
  'compliance.preovid.updated': [['preovid-audits'], ['preovid-responses'], ['compliance'], ['audits'], ['dashboard-kpis']],
  'compliance.peotram.audit_created': [['peotram-audits'], ['compliance'], ['audits'], ['dashboard-kpis']],
  'compliance.peotram.audit_updated': [['peotram-audits'], ['compliance'], ['audits'], ['dashboard-kpis']],
  'travel.reservation.created': [['reservations'], ['crew'], ['finance'], ['dashboard-kpis']],
  'travel.reservation.updated': [['reservations'], ['crew'], ['finance'], ['dashboard-kpis']],
  'fleet.downtime.created': [['vessel-downtimes'], ['fleet'], ['maintenance'], ['finance'], ['dashboard-kpis']],
  'fleet.downtime.updated': [['vessel-downtimes'], ['fleet'], ['maintenance'], ['finance'], ['dashboard-kpis']],
  'training.cbt.started': [['cbt-courses'], ['cbt-progress'], ['training'], ['crew'], ['dashboard-kpis']],
  'training.cbt.completed': [['cbt-courses'], ['cbt-progress'], ['training'], ['crew'], ['compliance'], ['certificates'], ['dashboard-kpis']],
  'recruitment.candidate.created': [['recruitment-candidatos'], ['recruitment-vagas'], ['crew'], ['dashboard-kpis']],
  'recruitment.candidate.updated': [['recruitment-candidatos'], ['recruitment-vagas'], ['crew'], ['dashboard-kpis']],
  'iot.sensor_data.created': [['iot-sensor-data'], ['running-hours'], ['maintenance'], ['tracking-sensors']],
  'finance.contract.created': [['contracts'], ['charter_parties'], ['finance'], ['fleet'], ['dashboard-kpis']],
  'finance.contract.updated': [['contracts'], ['charter_parties'], ['finance'], ['fleet'], ['dashboard-kpis']],
  'operations.task.created': [['autonomous-tasks'], ['action-items'], ['dashboard-kpis']],
  'operations.task.updated': [['autonomous-tasks'], ['action-items'], ['dashboard-kpis']],
  'document.version.created': [['document-versions'], ['documents'], ['entity-documents']],
};
