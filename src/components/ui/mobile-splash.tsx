    ...
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-700 flex items-center justify-center">
      <div className="text-center text-azure-50 animate-pulse">
        <div className="mb-8 relative">
          ...
          <div
            className="absolute -top-4 -right-4 w-8 h-8 bg-azure-100/10 rounded-full flex items-center justify-center animate-bounce"
        ...
        <h1 className="text-3xl font-bold mb-2 font-display">Nautilus One</h1>
        <p className="text-blue-100 text-lg mb-8">Sistema de Gestão Empresarial</p>

        <div className="flex justify-center items-center space-x-2">
          <div className="w-2 h-2 bg-azure-100 rounded-full animate-bounce"></div>
          <div
            className="w-2 h-2 bg-azure-100 rounded-full animate-bounce"
