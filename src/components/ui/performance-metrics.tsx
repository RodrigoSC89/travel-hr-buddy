      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {metrics.map(metric => {
          ...
          const isTarget =
            ...
            (metric.id === "incidents" && metric.value <= metric.target);
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className={cn("p-3 rounded-lg", `bg-${metric.color.split("-")[1]}/10`)}>
                  <Icon className={metric.color} size={24} />
                </div>
                <div
                  className={cn(
                    "flex items-center text-sm font-medium",
                    metric.trend === "up" && metric.id !== "incidents"
                      ? "text-success"
                      : metric.trend === "down" && metric.id !== "incidents"
                        ? "text-danger"
                        : metric.trend === "up" && metric.id === "incidents"
                          ? "text-danger"
                          : "text-success"
