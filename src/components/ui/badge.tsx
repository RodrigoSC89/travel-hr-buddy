  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-[11px] font-semibold tracking-wide transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground border-border/60 hover:bg-muted/50",
        ...
        active: "border-transparent bg-status-active text-status-active-foreground shadow-sm hover:bg-status-active/80",
        inactive: "border-transparent bg-status-inactive text-status-inactive-foreground hover:bg-status-inactive/80",
      },
    },
    defaultVariants: {
      variant: "default",
