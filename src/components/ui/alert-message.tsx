...
export const AlertMessage: React.FC<AlertMessageProps> = ({ type, title, message, className }) => {
  const styles = alertStyles[type];
  const IconComponent = styles.Icon;

  return (
    <div className={cn("rounded-lg border-l-4 p-4 transition-all", styles.container, className)}>
