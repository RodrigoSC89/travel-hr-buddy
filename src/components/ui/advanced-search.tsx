            ...
            <TabsContent value="results" className="mt-4">
              {results.length > 0 ? (
                <ScrollArea className="max-h-96">
                  <div className="space-y-2">
                    {results.map(result => (
                      ...
                      >
                        <div className="flex-shrink-0 text-primary">{result.icon}</div>
                ...
                <div className="text-center py-8 text-muted-foreground">
                  <Search className="h-8 w-8 mx-auto mb-2 opacity-50" />
                  <p className="text-sm">
                    Digite para buscar por páginas, documentos e funcionalidades
                  </p>
                </div>
              )}
            </TabsContent>
              ...
              {favorites.length > 0 ? (
                <div className="space-y-2">
                  {favorites.map(favorite => (
                    ...
                    >
                      <div className="flex-shrink-0 text-primary">{favorite.icon}</div>
                      <div className="flex-1 min-w-0">
