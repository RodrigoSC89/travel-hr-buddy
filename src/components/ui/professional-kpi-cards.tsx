...
import { TrendingUp, TrendingDown, DollarSign, Users, Award, Ship } from "lucide-react";
      ...
      {kpiData.map((kpi, index) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-br ${colorClasses.bg} rounded-lg opacity-95 group-hover:opacity-100 transition-opacity`}
            />
            ...
            <CardContent className="relative p-6 text-white">
              ...
              <div className="flex items-center justify-between mb-4">
                <div
                  className={`p-3 rounded-2xl bg-gradient-to-br ${colorClasses.icon} text-white shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300`}
                >
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm font-medium text-white/80">{kpi.subtitle}</div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-bold text-white">{kpi.title}</h3>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-bold text-white">{kpi.progress.toFixed(1)}%</span>
                  </div>
                </div>
