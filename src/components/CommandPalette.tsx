...
const quickActions = [
  ...
  { id: "operations-dashboard", label: "Operations Dashboard", icon: Activity, action: "/operations-dashboard" },
  { id: "ai-insights", label: "AI Insights", icon: Brain, action: "/ai-insights" },
