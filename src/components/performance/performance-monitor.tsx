...
export const PerformanceMonitor: React.FC = React.memo(() => {
  ...
  const scoreBadge = useMemo(() => getScoreBadge(metrics.score), [metrics.score, getScoreBadge]);
  const scoreColor = useMemo(() => getScoreColor(metrics.score), [metrics.score, getScoreColor]);
