  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
        <Card><CardContent className="pt-4"><div className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-emerald-500" /><span className="text-sm text-muted-foreground">A Receber</span></div><div className="text-xl font-bold text-emerald-500 mt-1">{formatCurrency(financialStats.totalReceivable)}</div></CardContent></Card>
        ...
        <Card><CardContent className="pt-4"><div className="flex items-center gap-2"><DollarSign className="h-4 w-4 text-primary" /><span className="text-sm text-muted-foreground">Posição Líquida</span></div><div className={`text-xl font-bold mt-1 ${financialStats.netPosition >= 0 ? "text-emerald-500" : "text-destructive"}`}>{formatCurrency(financialStats.netPosition)}</div></CardContent></Card>
        <Card><CardContent className="pt-4"><div className="flex items-center gap-2"><Clock className="h-4 w-4 text-amber-500" /><span className="text-sm text-muted-foreground">Desp. Pendentes</span></div><div className="text-xl font-bold text-amber-500 mt-1">{formatCurrency(financialStats.pendingExpenses)}</div></CardContent></Card>
        <Card><CardContent className="pt-4"><div className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-500" /><span className="text-sm text-muted-foreground">Desp. Aprovadas</span></div><div className="text-xl font-bold text-emerald-500 mt-1">{formatCurrency(financialStats.approvedExpenses)}</div></CardContent></Card>
