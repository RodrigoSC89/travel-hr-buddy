    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => toast.info('Use os cartões de métricas acima para filtrar por categoria (Score, Conforme, Não Conforme, Críticos).', { duration: 4000 })}><Filter className="w-4 h-4 mr-2" />Filtros</Button>
