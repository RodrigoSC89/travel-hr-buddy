...
const badgeColorMap: Record<string, string> = {
  ...
  "3D": "bg-info/20 text-info border-info/30",
  DEMO: "bg-warning/20 text-warning border-warning/30",
  IMCA: "bg-primary/20 text-primary border-primary/30",
  "13E": "bg-primary/20 text-primary border-primary/30",
  SMS: "bg-primary/20 text-primary border-primary/30",
  SSP: "bg-destructive/20 text-destructive border-destructive/30",
  SOLAS: "bg-warning/20 text-warning border-warning/30",
  DNV: "bg-primary/20 text-primary border-primary/30",
  "10 AI": "bg-accent/20 text-accent border-accent/30",
  "10": "bg-accent/20 text-accent border-accent/30",
  "11": "bg-accent/20 text-accent border-accent/30",
  CV: "bg-info/20 text-info border-info/30",
  GLOBAL: "bg-success/20 text-success border-success/30",
  IoT: "bg-info/20 text-info border-info/30",
  KPI: "bg-warning/20 text-warning border-warning/30",
  PDF: "bg-destructive/20 text-destructive border-destructive/30",
  PSC: "bg-primary/20 text-primary border-primary/30",
};
