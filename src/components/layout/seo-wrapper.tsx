    ...
    switch (pathname) {
      case "/":
        return {
          ...
          description:
            "Dashboard principal do sistema marítimo inteligente com IA e analytics avançados",
      ...
      case "/maritime":
        return {
          ...
          description:
            "Sistema completo de gestão marítima com monitoramento de embarcações e tripulação",
      ...
      default:
        return {
          ...
          description:
            "Plataforma completa para gestão marítima com IA, analytics avançados e automação inteligente",
