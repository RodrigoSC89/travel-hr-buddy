...
const groupedModules = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Portal do Funcionário", path: "/portal-funcionario" },
      { label: "Alertas de Preços", path: "/alertas-precos" },
      { label: "Reports Module", path: "/reports-module" },
      { label: "Automation", path: "/automation" },
      { label: "Real-Time Workspace", path: "/real-time-workspace" },
      { label: "Channel Manager", path: "/channel-manager" },
      { label: "Checklists Inteligentes", path: "/checklists-inteligentes" },
      { label: "Training Academy", path: "/training-academy" },
      { label: "Risk Management", path: "/risk-management" },
      { label: "Maintenance Planner", path: "/maintenance-planner" },
      { label: "Mission Logs", path: "/mission-logs" },
      { label: "Incident Reports", path: "/incident-reports" },
      { label: "Fuel Optimizer", path: "/fuel-optimizer" },
      { label: "Weather Dashboard", path: "/weather-dashboard" },
      { label: "Voyage Planner", path: "/voyage-planner" },
      { label: "Task Automation", path: "/task-automation" },
      { label: "Audit Center", path: "/audit-center" },
      { label: "Compliance Hub", path: "/compliance-hub" },
      { label: "AI Insights", path: "/ai-insights" },
      { label: "Logistics Hub", path: "/logistics-hub" },
      { label: "Crew Wellbeing", path: "/crew-wellbeing" },
      { label: "Satellite Tracker", path: "/satellite-tracker" },
      { label: "Project Timeline", path: "/project-timeline" },
      { label: "User Management", path: "/user-management" },
      { label: "Emergency Response", path: "/emergency-response" },
      { label: "Mission Control", path: "/mission-control" },
      { label: "Finance Hub", path: "/finance-hub" },
      { label: "API Gateway", path: "/api-gateway" },
      { label: "Analytics Core", path: "/analytics-core" },
      { label: "Document AI", path: "/document-ai" },
