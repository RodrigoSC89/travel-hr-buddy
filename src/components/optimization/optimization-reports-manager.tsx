    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Acompanhe otimizações aplicadas e gere relatórios detalhados</p>
        </div>
                        ...
                        <div className="flex items-center gap-4 text-sm text-muted-foreground">
                          ...
                          {report.status === 'ready' && (
                            <>
                              ...
                              <span className="text-success">+{report.performanceGain}% performance</span>
                            </>
                          )}
                        </div>
                      </div>
