                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {navigationStyles.map((style) => {
                      ...
                      return (
                        <div
                          key={style.id}
                          onClick={() => setSettings(prev => ({ ...prev, navigationStyle: style.id as CustomizationSettings["navigationStyle"] }))}
                          className={`p-4 border rounded-lg cursor-pointer transition-all hover:scale-105 ${
                  ...
                  <div className="space-y-4">
                    {terminologyOptions.map((option) => {
                      ...
                      return (
                        <div
                          key={option.id}
                          onClick={() => setSettings(prev => ({ ...prev, terminology: option.id as CustomizationSettings["terminology"] }))}
