            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={i} className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
                      ...
                      <Button size="sm" variant="outline" className="w-full mt-3" onClick={() => { navigator.clipboard.writeText(`Extensão: ${ext.name}\nAutor: ${ext.author}\nDownloads: ${ext.downloads}\nRating: ${ext.rating}`); sonnerToast.success(`Dados de "${ext.name}" copiados para clipboard`); }}>
                        Solicitar Acesso
                      </Button>
                    </div>
                  ))}
                ...
                <div className="border-t pt-4">
                  <Button variant="outline" onClick={() => { window.open('mailto:partnerships@nautilus.dev?subject=Parceria%20Developer', '_blank'); }}>
