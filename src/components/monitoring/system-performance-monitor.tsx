...
const SystemPerformanceMonitor = () => {
  ...
  const overallStatus =
    systemMetrics.every(m => m.status === "healthy") && services.every(s => s.status === "online")
      ? "healthy"
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-xs text-muted-foreground">
                      ...
                      {metric.unit} | Crítico: {metric.threshold.critical}
                      {metric.unit}
                    </div>
                  </div>
                </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Configure thresholds para receber alertas automáticos quando métricas críticas
                  forem atingidas.
                </p>
                <Button>
