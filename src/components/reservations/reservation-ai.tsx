...
export const ReservationAI: React.FC<ReservationAIProps> = ({
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
    case "conflict": return <AlertTriangle className="h-5 w-5 text-destructive" />;
    case "reminder": return <Clock className="h-5 w-5 text-primary" />;
    case "cost_saving": return <TrendingUp className="h-5 w-5 text-success" />;
    case "optimization": return <Lightbulb className="h-5 w-5 text-warning" />;
