            ...
            <Card><CardHeader><CardTitle className="flex items-center gap-2"><Zap className="h-5 w-5" />Ações Inteligentes</CardTitle></CardHeader>
              <CardContent>
                <div className="space-y-3">
                  ...
                  <Button onClick={() => { window.history.pushState({}, '', '/workbench?tab=medical'); window.dispatchEvent(new PopStateEvent('popstate')); }} variant="outline" className="w-full justify-start"><Stethoscope className="h-4 w-4 mr-2" />Telemedicina</Button>
