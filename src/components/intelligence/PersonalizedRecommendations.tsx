      ...
      const mockRecommendations: Recommendation[] = [
        {
          ...
          description:
            "Configure alertas automáticos para certificados que expiram em 30 dias para evitar problemas de compliance.",
          category: "Compliance",
          priority: "high",
        ...
        },
        {
          ...
          description:
            "Baseado no seu histórico, você pode economizar 23% usando nosso sistema de recomendações de voos.",
          category: "Economia",
          priority: "medium",
          actionType: "learn",
        ...
        },
        {
          ...
          description:
            "Configure a geração automática de relatórios para economizar 2 horas por semana.",
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div>
                                  ...
                                  <p
                                    className={`text-sm font-semibold ${getImpactColor(recommendation.estimatedImpact)}`}
                                  >
