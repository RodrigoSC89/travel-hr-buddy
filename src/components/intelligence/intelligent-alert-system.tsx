...
export const IntelligentAlertSystem = () => {
      ...
      const mockAlerts: SmartAlert[] = [
        {
          ...
          description:
            "IA detectou padrões anômalos na temperatura e vibração do motor principal. Falha prevista em 72h.",
          vessel_id: "1",
        ...
        },
        {
          ...
          description:
            "Tempestade tropical se aproximando da rota. Ventos de até 45 nós previstos.",
          vessel_id: "2",
        ...
        },
        {
          ...
          description:
            "IA identificou rota 12% mais eficiente para próxima viagem da MV Pacific Star.",
          vessel_id: "3",
        ...
        },
        {
          ...
          description:
            "Padrões de trabalho indicam níveis elevados de fadiga em 60% da tripulação.",
          vessel_id: "4",
        ...
        },
        {
          ...
          description:
            "Todas as certificações da frota estão em conformidade. Próxima revisão em 30 dias.",
          priority: "low",
          status: "resolved",
      ...
      const mockInsights: AIInsight[] = [
        {
          ...
          description:
            "Baseado em padrões históricos e condições meteorológicas, prevê-se aumento de 18% no consumo de combustível nos próximos 15 dias.",
          confidence_score: 89,
        ...
        },
        {
          ...
          description:
            "Análise de produtividade sugere nova configuração de escalas que pode aumentar eficiência em 23%.",
          confidence_score: 92,
        ...
        },
        {
          ...
          description:
            "Identificados padrões que sugerem manutenção preditiva pode reduzir custos de reparo em 35%.",
          confidence_score: 87,
          business_impact: "high",
  ...
  const filteredAlerts = smartAlerts.filter(
    alert => filterType === "all" || alert.category === filterType
  );
      ...
      {(criticalAlerts > 0 || warningAlerts > 0) && (
        <Alert className="border-red-200 bg-red-50">
          ...
          <AlertDescription className="text-red-800">
            <strong>Atenção:</strong> {criticalAlerts} alerta(s) crítico(s) e {warningAlerts}{" "}
            aviso(s) requerem ação imediata.
          </AlertDescription>
        </Alert>
      )}
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getHealthColor(systemHealth.fleet_efficiency)}`}
                >
              ...
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getHealthColor(systemHealth.safety_compliance)}`}
                >
              ...
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getHealthColor(systemHealth.fuel_optimization)}`}
                >
                      ...
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge variant="outline">IA: {alert.ai_confidence}%</Badge>
                          </div>
                        ...
                        <Badge
                          className={
                            insight.business_impact === "high"
                              ...
                              : insight.business_impact === "medium"
