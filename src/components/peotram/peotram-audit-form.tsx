      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <RadioGroup
            ...
            onValueChange={(value: "compliant" | "non-compliant" | "not-applicable" | "partial") => setFormData(prev => ({ ...prev, score: value }))}
          >
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: "critical" | "high" | "medium" | "low") => setFormData(prev => ({ ...prev, criticality: value }))}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
