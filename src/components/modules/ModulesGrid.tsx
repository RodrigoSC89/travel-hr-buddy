// ✅ Grid de Módulos — Interface Inteligente para Nauti One
...
const modules: Module[] = [
  ...
  { name: "Centro de Notificações", icon: Bell, category: "Sistema", slug: "notifications", status: "functional" },
  { name: "Monitor de Sistema", icon: Cpu, category: "Sistema", slug: "health-monitor", status: "functional" },
  { name: "Documentos", icon: FileText, category: "Documentos", slug: "documents", status: "functional" },
  { name: "Colaboração", icon: Users, category: "Comunicação", slug: "collaboration", status: "functional" },
  { name: "Otimização Mobile", icon: Smartphone, category: "IA", slug: "mobile", status: "functional" },
  ...
  { name: "Templates", icon: Copy, category: "Documentos", slug: "templates", status: "functional" },
  { name: "Analytics Avançado", icon: BarChartBig, category: "Análise", slug: "analytics", status: "functional" },
  { name: "Analytics Tempo Real", icon: Activity, category: "Análise", slug: "realtime", status: "functional" },
  { name: "Monitor Avançado", icon: Monitor, category: "Sistema", slug: "system-monitor", status: "functional" },
  { name: "Documentos IA", icon: FileCode2, category: "IA", slug: "documents-ai", status: "functional" },
  { name: "Assistente IA", icon: Bot, category: "IA", slug: "ai-assistant", status: "functional" },
  { name: "Business Intelligence", icon: AreaChart, category: "Análise", slug: "bi", status: "functional" },
  { name: "Smart Workflow", icon: Repeat, category: "IA", slug: "workflow", status: "functional" },
  { name: "Vault Técnico IA", icon: FolderSearch, category: "IA", slug: "vault-ai", status: "functional" },
  { name: "Centro de Ajuda", icon: HelpCircle, category: "Ajuda", slug: "help", status: "functional" },
  { name: "Automação IA", icon: Settings2, category: "IA", slug: "automation", status: "functional" },
  { name: "Visão Geral", icon: Eye, category: "Core", slug: "overview", status: "functional" },
];
