  ...
  const [suggestions] = useState<AISuggestion[]>([
    {
      ...
      description:
        "Implementar cache inteligente pode reduzir latência em 45% e diminuir custos de requisições.",
      priority: "medium",
    ...
    },
    {
      ...
      description:
        "Baseado no seu uso de alertas, uma integração com Slack pode melhorar a comunicação da equipe.",
      priority: "low",
      estimatedImpact: "Melhoria na comunicação de 60%",
      actions: [
        "Configurar webhook Slack",
        "Criar templates de mensagem",
        "Definir canais por tipo",
      ],
    },
    {
      id: "3",
      ...
      description:
        "Alguns tokens expirarão em breve. Configure renovação automática para evitar interrupções.",
      priority: "high",
    ...
    },
    {
      ...
      description:
        "Detectamos falhas intermitentes na API do WhatsApp. Implementar retry com backoff exponencial.",
      priority: "critical",
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm mb-3">
                    <div>
                      ...
                      <p className="font-medium text-foreground">
                        {diagnostic.performance.responseTime}ms
                      </p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Taxa Sucesso</p>
                      <p className="font-medium text-foreground">
                        {diagnostic.performance.successRate}%
                      </p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Taxa Erro</p>
                      <p className="font-medium text-foreground">
                        {diagnostic.performance.errorRate}%
                      </p>
                    </div>
                  </div>
