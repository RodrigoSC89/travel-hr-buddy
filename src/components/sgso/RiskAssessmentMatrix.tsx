...
const getRiskColor = (level: string) => {
  const colors: Record<string, string> = {
    ...
    medium: "bg-warning/80 text-foreground",
    low: "bg-primary text-primary-foreground",
    negligible: "bg-success text-success-foreground"
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-warning/10 border-warning/30"><CardContent className="p-4"><div className="flex items-center justify-between"><div><p className="text-sm text-warning">Altos</p><p className="text-2xl font-bold">{highCount}</p></div><TrendingUp className="h-8 w-8 text-warning opacity-70" /></div></CardContent></Card>
        <Card className="bg-warning/10 border-warning/30"><CardContent className="p-4"><div className="flex items-center justify-between"><div><p className="text-sm text-warning">Médios</p><p className="text-2xl font-bold">{mediumCount}</p></div><Activity className="h-8 w-8 text-warning opacity-70" /></div></CardContent></Card>
