// SGSO (Sistema de Gestão de Segurança Operacional) Component Exports

export { SgsoDashboard } from "./SgsoDashboard";
export { PainelSGSO } from "./PainelSGSO";
...
export { IbamaRequirementsList } from "./IbamaRequirementsList";
