...
import { Users, MessageCircle, Video, Share2, Bell, Activity, Zap, Eye, Plus } from "lucide-react";
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card className="bg-gradient-to-br from-background to-muted/20">
        <CardHeader>
          ...
          <CardDescription>Veja quem está online e trabalhando no sistema agora</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="bg-gradient-to-br from-background to-muted/20">
        <CardHeader>
          ...
          <CardDescription>Atualizações e notificações em tempo real</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
