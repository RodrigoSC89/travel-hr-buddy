            ...
            {selectedItem ? (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Button variant="outline" size="sm" className="mt-2 gap-2" onClick={() => toast.info('Anexar Evidência', { description: 'Upload de evidência disponível via Document Center. Navegue até Documentos para anexar arquivos a esta auditoria.', duration: 5000 })}>
