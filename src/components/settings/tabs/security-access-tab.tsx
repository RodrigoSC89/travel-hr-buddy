    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg border">
                ...
                <div
                  className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${strength.color} ${strength.bg}`}
                >
                  {strength.level === "Alta" ? (
          ...
          {settings.twoFactorRequired && (
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                Todos os novos usuários serão obrigados a configurar 2FA no primeiro login. Usuários
                existentes terão 7 dias para configurar.
              </p>
            </div>
          )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure permissões e políticas de acesso por perfil</CardDescription>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Gestão de pessoal e certificações
              </p>
              <Button variant="outline" size="sm" className="w-full">
                <Settings className="w-4 h-4 mr-2" />
                Configurar
