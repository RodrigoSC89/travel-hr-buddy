  ...
  const aiRecommendations = [
    {
      ...
      description:
        "Considere reduzir o tempo de expiração de sessão para 15 minutos para usuários com privilégios administrativos.",
      priority: "high",
      category: "security",
      confidence: 85,
    },
    {
      ...
      description:
        "Baseado no uso, recomendamos desabilitar notificações push fora do horário comercial para melhorar a experiência.",
      priority: "medium",
    ...
    },
    {
      ...
      description:
        "Detectamos uso frequente de planilhas. Considere integrar com Google Sheets ou Microsoft Excel Online.",
      priority: "low",
        ...
        <TabsContent value="documents" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Acesse termos, políticas e documentos do sistema</CardDescription>
            </CardHeader>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1 text-xs text-muted-foreground">
                        ...
                        <span>•</span>
                        <span>
                          Atualizado em {new Date(doc.lastUpdated).toLocaleDateString("pt-BR")}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-sm text-blue-700">
                  Nossa IA analisa continuamente o uso do sistema para sugerir otimizações. Novas
                  recomendações são geradas automaticamente a cada 24 horas.
                </p>
              </div>
            </CardContent>
          </Card>
