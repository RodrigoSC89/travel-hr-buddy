...
const EnhancedUnifiedDashboard = () => {
  ...
  const [dashboardData, setDashboardData] = useState({
    ...
    alerts: [
      {
        id: 1,
        title: "Certificado STCW da MV Ocean Explorer expira em 15 dias",
        type: "warning",
        priority: "high",
        module: "hr",
      ...
      {
        id: 2,
        title: "Meta mensal de eficiência operacional atingida - 94.2%",
        type: "success",
        priority: "medium",
        module: "fleet",
        percentage: 94.2,
      ...
      {
        id: 3,
        title: "Análise IA detectou 3 oportunidades de otimização no PEOTRAM",
        type: "info",
        priority: "medium",
        module: "peotram",
        insights: 3,
      ...
      {
        id: 4,
        title: "Backup automático da base de dados concluído com sucesso",
        type: "success",
        priority: "low",
        module: "system",
        size: "2.3GB",
      ...
      {
        id: 5,
        title: "Manutenção preventiva agendada para MV Atlantic Dawn",
        type: "warning",
        priority: "medium",
        module: "maintenance",
    ...
    recentActivities: [
      {
        id: 1,
        user: "João Silva",
        action: "Completou auditoria PEOTRAM #2024-001 com score 98.5%",
        time: "2h atrás",
        type: "peotram",
        vessel: "MV Ocean Explorer",
        score: 98.5,
      },
      {
        id: 2,
        user: "Maria Santos",
        action: "Aprovou relatório mensal de frota - Janeiro 2024",
        time: "4h atrás",
        type: "fleet",
        documents: 15,
      },
      {
        id: 3,
        user: "Carlos Lima",
        action: "Atualizou cronograma de viagem para rota Santos-Houston",
        time: "6h atrás",
        type: "travel",
      ...
      },
      {
        id: 4,
        user: "Ana Costa",
        action: "Upload de certificado STCW renovado",
        time: "8h atrás",
        type: "certificate",
        validity: "5 anos",
      },
      {
        id: 5,
        user: "Pedro Oliveira",
        action: "Finalizou inspeção de segurança com nota A+",
        time: "1d atrás",
        type: "safety",
        grade: "A+",
      },
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      {currentTenant?.plan_type && (
                        <Badge className="text-sm bg-gradient-to-r from-secondary to-secondary-light">
                          ...
                          {currentTenant.plan_type.charAt(0).toUpperCase() +
                            currentTenant.plan_type.slice(1)}
                        </Badge>
                      )}
                    ...
                    <p className="text-foreground mt-3 text-lg font-medium">
                      ...
                      <br />
                      Painel executivo de operações marítimas em tempo real.
                    </p>
                  </div>
                </div>
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Progress
                    value={dashboardData.financialMetrics.grossMargin}
                ...
                <div className="space-y-2">
                  ...
                  <Progress
                    value={dashboardData.financialMetrics.operatingMargin * 2}
                    className="h-2 bg-white/20"
                  />
                </div>
                <div className="space-y-2">
                ...
                >
                  ...
                  <CardContent className="relative p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`p-4 rounded-2xl bg-gradient-to-br ${action.color} text-azure-50 shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300`}
                      >
