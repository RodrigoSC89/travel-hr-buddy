...
export const NAVIGATION = [
  ...
  { name: "Tripulação", path: "/crew", component: safeLazyImport(() => import("@/pages/MaritimeCommandCenter"), "Maritime Command Center") },
  { name: "Checklists Marítimos", path: "/maritime-checklists", component: safeLazyImport(() => import("@/pages/MaritimeCommandCenter"), "Maritime Command Center") },
  { name: "Certificações Marítimas", path: "/maritime-certifications", component: safeLazyImport(() => import("@/pages/MaritimeCommandCenter"), "Maritime Command Center") },
  ...
  { name: "Manutenção Inteligente", path: "/intelligent-maintenance", component: safeLazyImport(() => import("@/pages/MaintenanceCommandCenter"), "Maintenance Command Center") },
  { name: "MMI - Manutenção", path: "/mmi", component: safeLazyImport(() => import("@/pages/MaintenanceCommandCenter"), "Maintenance Command Center") },
  ...
  { name: "Mission Logs", path: "/mission-logs", component: safeLazyImport(() => import("@/pages/MissionCommandCenter"), "Mission Command Center") },
  { name: "Mission Control", path: "/mission-control", component: safeLazyImport(() => import("@/pages/MissionCommandCenter"), "Mission Command Center") },
  ...
  { name: "Revolutionary AI", path: "/revolutionary-ai", component: safeLazyImport(() => import("@/pages/AICommandCenter"), "AI Command Center") },
  { name: "AI Dashboard", path: "/ai-dashboard", component: safeLazyImport(() => import("@/pages/AICommandCenter"), "AI Command Center") },
  { name: "AI Insights", path: "/ai-insights", component: safeLazyImport(() => import("@/pages/AICommandCenter"), "AI Command Center") },
  { name: "Automation", path: "/automation", component: safeLazyImport(() => import("@/pages/AICommandCenter"), "AI Command Center") },
