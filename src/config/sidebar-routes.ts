  ...
  // ============================================
{
  ...
  // ============================================
  {
    ...
    items: [
      ...
      { label: "Charter Party", path: "/charter-party", icon: FileText, emoji: "📜", badge: "NEW" },
      { label: "Cargo Management", path: "/cargo-management", icon: Ship, emoji: "📦", badge: "NEW" },
      { label: "Port Call Optimization", path: "/port-call-optimization", icon: Anchor, emoji: "⚓", badge: "NEW" },
