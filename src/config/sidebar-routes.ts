...
export const SIDEBAR_ROUTES: SidebarGroup[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "Berth Scheduling", path: "/ops?tab=port-ops", icon: Calendar, emoji: "🏗️", status: "new" },
      { label: "Barging/STS", path: "/ops?tab=port-ops", icon: Layers, emoji: "🔄", status: "new" },
      { label: "Trading & Risk", path: "/ops?tab=trading", icon: DollarSign, emoji: "📉", status: "new" },
      { label: "Forum & Knowledge", path: "/ops?tab=forum", icon: MessageSquare, emoji: "💡", status: "new" },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "Trim & Propulsion", path: "/maintenance?tab=trim-propulsion", icon: Activity, emoji: "⚙️", status: "new" },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "Invoice Matching", path: "/workbench?section=procurement", icon: FileText, emoji: "🔍", status: "new" },
      { label: "Supplier Portal", path: "/workbench?section=procurement", icon: Globe, emoji: "🏪", status: "new" },
      { label: "Return Goods", path: "/workbench?section=procurement", icon: Package, emoji: "📦", status: "new" },
