          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg opacity-95 mb-8 max-w-3xl drop-shadow-md font-medium">
                Sistema revolucionário de gestão de RH com IA preditiva, automação completa e
                experiência extraordinária para toda equipe marítima.
              </p>
          ...
          actions={[
            {
              ...
              action: () => {}, // TODO: Implement new employee action
              variant: "default",
            },
            {
              id: "reports",
            ...
            },
            {
              ...
              action: () => {}, // TODO: Implement payroll action
              variant: "outline",
            },
            {
              id: "training",
              ...
              action: () => {}, // TODO: Implement training action
              variant: "outline",
            },
          ]}
          quickActions={[
