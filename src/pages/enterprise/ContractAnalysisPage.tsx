    ...
    for (const file of acceptedFiles) {
      ...
      try {
        ...
        const completedAnalysis: ContractAnalysis = {
          ...
          opportunities: [
            { description: 'Renegociar cláusula de combustível para split 50/50', potentialSavings: 42000 },
            { description: 'Incluir bônus de performance (uptime >98%)', potentialSavings: 23000 },
          ],
          status: 'completed',
          analyzedAt: new Date(),
        };
