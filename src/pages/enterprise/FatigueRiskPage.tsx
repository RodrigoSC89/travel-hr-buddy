    ...
    <>
      ...
      <div className="container mx-auto py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card><CardContent className="pt-4"><div className="flex items-center justify-between"><div><p className="text-3xl font-bold text-amber-500">{stats.mlcViolations}</p><p className="text-xs text-muted-foreground">Violações MLC</p></div><div className="p-2 rounded-lg bg-amber-500/10"><FileText className="h-5 w-5 text-amber-500" /></div></div></CardContent></Card>
