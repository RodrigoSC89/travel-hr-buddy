  ...
  const PRICING_TIERS = [
    {
      ...
      modules: [
        ...
        t('landing.pricing.starterMod3'),
        t('landing.pricing.starterMod4'),
        t('landing.pricing.starterMod5'),
        t('landing.pricing.starterMod6'),
      ],
      extras: [t('landing.pricing.emailSupport'), t('landing.pricing.updatesIncluded')],
    },
    {
      id: 'pro',
      name: 'Professional',
      ...
      modules: [
        ...
        t('landing.pricing.proMod2'),
        t('landing.pricing.proMod3'),
        t('landing.pricing.proMod4'),
        t('landing.pricing.proMod5'),
        t('landing.pricing.proMod6'),
        t('landing.pricing.proMod7'),
        t('landing.pricing.proMod8'),
      ],
      extras: [t('landing.pricing.prioritySupport'), t('landing.pricing.dedicatedOnboarding'), t('landing.pricing.sla995')],
    },
    {
      id: 'enterprise',
      name: 'Enterprise',
      ...
      modules: [
        t('landing.pricing.allFromPro'),
        t('landing.pricing.entMod1'),
        t('landing.pricing.entMod2'),
        t('landing.pricing.entMod3'),
        t('landing.pricing.entMod4'),
        t('landing.pricing.entMod5'),
        t('landing.pricing.entMod6'),
      ],
      extras: [t('landing.pricing.support247'), t('landing.pricing.sla9999'), t('landing.pricing.dedicatedManager'), t('landing.pricing.onsiteTraining')],
    },
  ];
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex gap-2">
                      <Badge className="bg-success/90 text-success-foreground text-[10px]">
                        <Activity className="h-3 w-3 mr-1" /> {t('landing.hero.liveTracking')}
                      </Badge>
                      <Badge className="bg-primary/90 text-primary-foreground text-[10px]">
                        <Brain className="h-3 w-3 mr-1" /> {t('landing.hero.aiActive')}
                      </Badge>
                    </div>
                  </div>
                </div>
        ...
        <section id="differentiators" className="py-20 px-4 bg-muted/20 border-y border-border/20">
          <div className="container mx-auto max-w-6xl">
            <ScrollReveal className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-3">
                {t('landing.diff.heading')}
              </h2>
              <p className="text-muted-foreground text-base max-w-2xl mx-auto">
                {t('landing.diff.subheading')}
              </p>
            </ScrollReveal>
                ...
                return (
                  <StaggerItem key={tier.id}>
                    <Card className={`relative flex flex-col h-full transition-all ${tier.recommended ? 'border-primary shadow-xl shadow-primary/10 scale-[1.03] z-10' : 'border-border/40 hover:border-primary/20'}`}>
                      {tier.recommended && (
                        <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary shadow-lg text-xs">{t('landing.pricing.mostPopular')}</Badge>
                      )}
                      ...
                      <CardContent className="text-center flex-1">
                        <div className="mb-4">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            {tier.limits.vessels ? t('landing.pricing.upTo', { vessels: tier.limits.vessels, crew: tier.limits.crew }) : t('landing.pricing.unlimited')}
                          </p>
                        </div>
                      ...
                      <CardFooter className="pt-0">
                        ...
                        >
                          {tier.isEnterprise ? t('landing.pricing.talkToSales') : t('landing.hero.startTrial')}
            ...
            <ScrollReveal>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Button size="lg" variant="outline" className="gap-2 text-base px-8" asChild>
                  <a href="mailto:comercial@nautione.com.br">{t('landing.cta.talkExpert')}</a>
                </Button>
              </div>
            </ScrollReveal>
          </div>
