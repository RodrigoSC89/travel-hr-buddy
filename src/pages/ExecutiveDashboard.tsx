              ...
              <Card key={index} className="relative overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">{kpi.metric}</p>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2 mt-3">
                        <Badge
                          variant="outline"
                          className="text-xs bg-white dark:bg-blue-950 border-blue-300"
                        >
                          6 Seções
                        </Badge>
                        <Badge
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2 mt-3">
                        <Badge
                          variant="outline"
                          className="text-xs bg-white dark:bg-red-950 border-red-300"
                        >
                          17 Práticas
                        </Badge>
                        <Badge
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2 mt-3">
                        <Badge
                          variant="outline"
                          className="text-xs bg-white dark:bg-green-950 border-green-300"
                        >
                          Wizard 8 Etapas
                        </Badge>
                        <Badge
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center gap-4 p-3 hover:bg-muted/50 rounded-lg"
                  >
