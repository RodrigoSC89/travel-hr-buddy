...
const Strategic: React.FC = () => {
  const [activeModule, setActiveModule] = useState<
    "overview" | "copilot" | "identity" | "integrations" | "api" | "ai-advanced" | "predictive"
  >("overview");
  ...
  const strategicModules = [
    ...
    },
    {
      ...
      description:
        "Conectores inteligentes para APIs marítimas, governamentais e sistemas externos",
      icon: Link,
            ...
            <Card className="card-vessel overflow-hidden relative">
              ...
              <CardHeader className="relative z-10 pb-8">
                ...
                <p className="text-lg opacity-90 max-w-3xl text-balance">
                  Sistema revolucionário que integra IA marítima, customização náutica avançada e
                  automações inteligentes para elevar sua operação ao próximo nível de excelência
                  oceânica.
                </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {kpis.map((kpi, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="card-vessel hover-lift animate-fade-in"
                    ...
                    >
                      ...
                      <CardHeader className="pb-4">
                        <div className="flex items-start justify-between mb-4">
                          <div
                            className={`p-3 rounded-xl bg-gradient-to-br ${module.color} bg-opacity-20 group-hover:scale-110 transition-transform float-element`}
                          >
                            <Icon className="w-6 h-6 text-azure-50" />
                          </div>
                          <Badge className="badge-captain">{module.status}</Badge>
                        </div>
