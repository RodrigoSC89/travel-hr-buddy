...
export default function MMIForecastPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setForecast('Erro ao gerar previsão. Por favor, tente novamente.')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold">🧠 Forecast IA - Manutenção Inteligente</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input type="number" value={hourmeter} onChange={(e) => setHourmeter(e.target.value)} />
          </div>
        ...
        <div>
          ...
          <Textarea rows={18} value={forecast} readOnly />
        </div>
      </div>
    </div>
  )
