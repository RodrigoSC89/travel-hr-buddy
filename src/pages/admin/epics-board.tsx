...
export default function EpicsBoard() {
  ...
  const epics: Epic[] = [
    ...
    {
      id: "epic-005",
      name: "Maritime Operations & Safety Modules (PATCHES 608-612)",
      description: "Travel intelligence, ISM audits, OVID inspections, PSC pre-inspection, and LSA/FFA safety inspections",
      status: "in_progress",
      start_date: "2025-11-03",
      target_date: "2026-03-31",
      owner: "Maritime Safety Team",
      patches: [
        {
          id: "patch-608",
          number: "PATCH 608",
          name: "Travel Intelligence Module",
          description: "Integração com APIs de busca de passagens e hospedagens (Skyscanner, Booking, Google Flights). Recomendação com LLM, deep links para LATAM/GOL/MaxMilhas, e UI interativa com histórico.",
          status: "completed",
          progress: 100,
          modules: ["travel-search", "llm-flight-advisor", "skyscanner-api"],
        ...
        },
        {
          ...
          description: "Otimizações gerais do módulo de viagem. Cache, fallback, novos testes, UI responsiva e segurança com chaves.",
          status: "completed",
          progress: 100,
          modules: ["travel-search", "deeplink-builder"],
          dependencies: ["patch-608"],
          validation_status: "passed",
        },
        {
          id: "patch-609",
          ...
          description: "Módulo completo para auditorias ISM com OCR, assistente LLM, checklist digital, análise de conformidade e exportação PDF.",
          status: "completed",
          progress: 100,
          modules: ["ism-audits", "ism-assistant", "ocr-pdf"],
          dependencies: ["supabase", "llm", "ocr"],
          validation_status: "passed",
        },
        {
          id: "patch-610",
          ...
          description: "Módulo de pré-auditorias baseado no OCIMF OVID com checklist digital inteligente, evidências, e dashboard por tipo de navio.",
          status: "in_progress",
          progress: 60,
          modules: ["ovid-precheck", "evidence-uploader", "audit-navigator"],
          dependencies: ["supabase", "ocr", "llm"],
          validation_status: "pending",
        },
        {
          id: "patch-611",
          ...
          description: "Implementação de verificação digital com base nos guias DNV e IMO para inspeções Port State Control. Geração de relatórios de conformidade, alertas críticos e LLM contextual.",
          status: "in_progress",
          progress: 45,
          modules: ["psc-precheck", "compliance-reports", "critical-alerts"],
          dependencies: ["supabase", "watchdog", "llm"],
          validation_status: "pending",
        },
        {
          id: "patch-612",
          ...
          description: "Checklist de equipamentos de segurança (LSA e FFA) com base em SOLAS. Sistema de inspeção com OCR, pontuação de segurança e painel de conformidade.",
          status: "in_progress",
          progress: 40,
          modules: ["lsa-ffa-inspection", "safety-scoring", "compliance-panel"],
          dependencies: ["supabase", "ocr", "llm"],
          validation_status: "pending",
        },
      ],
