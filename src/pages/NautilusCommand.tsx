/**
 * Nauti Command Page - Entry point for the unified command center
...
import NautiCommandCenterUnified from "@/modules/nauti-command-center";
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="/nauti-command" />
      </Helmet>
      <NautiCommandCenterUnified />
    </>
  );
}