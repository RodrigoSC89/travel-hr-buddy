...
const esTranslations = {
  ...
  crew: {
    ...
    members: 'Miembros de la Tripulación',
  ...
  voyages: {
    ...
    eta: 'ETA',
    etd: 'ETD',
    noonReport: 'Informe del Mediodía',
    portCall: 'Escala',
    weather: 'Clima',
    fuel: 'Combustible',
    cargo: 'Carga',
  ...
  emergency: {
    ...
    subtitle: 'Solo Funciones Críticas',
    sos: 'SOS',
    mayday: 'MAYDAY',
    panpan: 'PAN-PAN',
    mrcc: 'Contactar MRCC',
    dpa: 'Contactar DPA',
    musterList: 'Lista de Llamada',
    headCount: 'Conteo de Personal',
    lifeboat: 'Estaciones de Botes',
    fireStations: 'Estaciones de Incendio',
    manOverboard: 'Hombre al Agua',
    abandon: 'Abandonar Buque',
    incidentLog: 'Registro de Incidentes',
    gpsPosition: 'Posición GPS',
    timestamp: 'Fecha/Hora',
    recordIncident: 'Registrar Incidente',
    exitEmergency: 'Salir del Modo Emergencia',
    confirmExit: '¿Está seguro de que desea salir del modo emergencia?',
    activeAlert: 'Alerta de Emergencia Activa',
    allHandsSafe: 'Todo el Personal a Salvo',
    missingPersonnel: 'Personal Desaparecido',
  },
  settings: {
    title: 'Configuración',
    language: 'Idioma',
