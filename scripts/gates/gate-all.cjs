...
// Gate configuration
const GATES = [
  { name: 'Console Check', script: 'gate-console.cjs', priority: 'P0' },
  { name: 'Mock Data Check', script: 'gate-mocks.cjs', priority: 'P0' },
  { name: 'Fake API Check', script: 'gate-fake-api.cjs', priority: 'P0' },
  { name: 'TS Ignore Check', script: 'gate-ts-ignore.cjs', priority: 'P1' },
  { name: 'Any Type Check', script: 'gate-any.cjs', priority: 'P1' },
  { name: 'Route Orphans', script: 'gate-routes.cjs', priority: 'P2' },
];
