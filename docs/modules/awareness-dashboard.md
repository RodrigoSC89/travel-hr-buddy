# Awareness Dashboard Module

## Overview

The Awareness Dashboard module is part of the Nautilus One system.
...
```typescript
import { AwarenessDashboard } from '@/modules/awareness-dashboard';

function App() {
  return <AwarenessDashboard />;
}
```
...
### Testing
```bash
npm run test awareness-dashboard
```
