# Incident Replayer Module

## Overview

The Incident Replayer module is part of the Nautilus One system.
...
```typescript
import { IncidentReplayer } from '@/modules/incident-replayer';

function App() {
  return <IncidentReplayer />;
}
```
...
### Testing
```bash
npm run test incident-replayer
```
