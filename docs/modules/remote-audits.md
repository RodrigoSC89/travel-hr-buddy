# Remote Audits Module

## Overview

The Remote Audits module is part of the Nautilus One system.
...
```typescript
import { RemoteAudits } from '@/modules/remote-audits';
