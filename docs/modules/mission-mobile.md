# Mission Mobile Module

## Overview

The Mission Mobile module is part of the Nautilus One system.
...
```typescript
import { MissionMobile } from '@/modules/mission-mobile';

function App() {
  return <MissionMobile />;
}
```
