# Reaction Mapper Module

## Overview

The Reaction Mapper module is part of the Nautilus One system.
...
```typescript
import { ReactionMapper } from '@/modules/reaction-mapper';
