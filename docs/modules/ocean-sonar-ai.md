# Ocean Sonar Ai Module

## Overview

The Ocean Sonar Ai module is part of the Nautilus One system.
...
```typescript
import { OceanSonarAi } from '@/modules/ocean-sonar-ai';
