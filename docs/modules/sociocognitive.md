# Sociocognitive Module

## Overview

The Sociocognitive module is part of the Nautilus One system.
...
```typescript
import { Sociocognitive } from '@/modules/sociocognitive';

function App() {
  return <Sociocognitive />;
}
```
