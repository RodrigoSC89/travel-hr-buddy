# Copilot Presenter Module

## Overview

The Copilot Presenter module is part of the Nautilus One system.
...
```typescript
import { CopilotPresenter } from '@/modules/copilot-presenter';

function App() {
  return <CopilotPresenter />;
}
```
...
### Testing
```bash
npm run test copilot-presenter
```
