...
The I18n Dashboard module is part of the Nautilus One system.
...
```typescript
import { I18nDashboard } from '@/modules/i18n-dashboard';

function App() {
  return <I18nDashboard />;
}
```
