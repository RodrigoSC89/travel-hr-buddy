# Predictive Strategy Module

## Overview

The Predictive Strategy module is part of the Nautilus One system.
...
```typescript
import { PredictiveStrategy } from '@/modules/predictive-strategy';
...
### Testing
```bash
npm run test predictive-strategy
```
