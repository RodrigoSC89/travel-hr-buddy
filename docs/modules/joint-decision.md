# Joint Decision Module

## Overview

The Joint Decision module is part of the Nautilus One system.
...
```typescript
import { JointDecision } from '@/modules/joint-decision';
