# Multilingual Logs Module

## Overview

The Multilingual Logs module is part of the Nautilus One system.
...
```typescript
import { MultilingualLogs } from '@/modules/multilingual-logs';

function App() {
  return <MultilingualLogs />;
}
```
...
### Testing
```bash
npm run test multilingual-logs
```
