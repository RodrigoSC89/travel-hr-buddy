...
Updated to:
- Expand the grid layout to include ForecastDashboard in a 3-column top row
...
### Before
- Top row with 2 panels
- Additional monitoring panels below

### After
- **3-column top row**: ControlHubPanel + SystemAlerts + **ForecastDashboard** ⭐
- Additional monitoring panels in 2-column grid
- Incident Response and AI Insights full-width sections
...
### 1. ONNX Model
The included model file (`public/models/nautilus_forecast.onnx`) is a placeholder. For production use:
