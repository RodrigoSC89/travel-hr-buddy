...
# === MAPS & WEATHER ===
# Mapbox - Mapas interativos (Frontend)
VITE_MAPBOX_TOKEN=pk.eyJ1...
VITE_MAPBOX_ACCESS_TOKEN=pk.eyJ...

# Mapbox - Supabase Functions
MAPBOX_PUBLIC_TOKEN=pk.eyJ...

# OpenWeather - Dados meteorológicos
VITE_OPENWEATHER_API_KEY=...        # Frontend (opcional)
OPENWEATHER_API_KEY=...             # Supabase Functions (obrigatório para maritime-weather)

# Windy - Visualização meteorológica avançada (Integração futura)
WINDY_API_KEY=                      # Opcional - Não implementado ainda
