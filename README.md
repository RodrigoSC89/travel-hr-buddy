...
- 📙 [Configuration Examples](./EMAIL_ALERT_CONFIG_EXAMPLES.md) - Gmail, Outlook, SendGrid, SES
- 📕 [Visual Guide](./EMAIL_ALERT_VISUAL_GUIDE.md) - See what the reports look like
