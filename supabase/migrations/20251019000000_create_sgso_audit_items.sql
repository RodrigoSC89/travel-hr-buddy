...
-- Detailed items for SGSO audits with 17 requirements
-- ===========================
...
CREATE INDEX idx_sgso_audit_items_audit ON public.sgso_audit_items(audit_id);
CREATE INDEX idx_sgso_audit_items_requirement ON public.sgso_audit_items(requirement_number);
CREATE INDEX idx_sgso_audit_items_status ON public.sgso_audit_items(compliance_status);
