-- Add required fields to auditorias_imca table for IMCA audit listing
-- Fields: navio, norma, item_auditado, resultado, comentarios, data
...
COMMENT ON COLUMN public.auditorias_imca.norma IS 'Norma IMCA aplicada na auditoria';
...
COMMENT ON COLUMN public.auditorias_imca.comentarios IS 'Comentários sobre a auditoria';
COMMENT ON COLUMN public.auditorias_imca.data IS 'Data em que a auditoria foi realizada';
