...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Você é um assistente especializado em criar resumos concisos e objetivos de documentos.

    Suas habilidades incluem:
    - Identificar os pontos principais e mais importantes do texto
    - Criar resumos claros e diretos
    - Manter a essência e o contexto do documento original
    - Usar linguagem profissional e acessível
    
    Instruções:
    - Crie um resumo de 2-4 parágrafos
