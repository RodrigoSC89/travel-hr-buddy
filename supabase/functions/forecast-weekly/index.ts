...
// Enhanced with Real GPT-4 Intelligence (Etapa 8)
// ============================================================================
  ...
  try {
    ...
    for (const job of jobs as Job[]) {
      try {
        ...
        console.log(`✅ GPT-4 forecast generated for ${job.job_id}: ${forecast.proxima_execucao} (${forecast.risco_estimado})`);
        ...
        forecastsCreated++;
        console.log(`✅ Forecast saved to database for job ${job.job_id}`);
