...
│  📄 Document Title                                   │
│  Criado em 11 de outubro de 2025 às 14:30          │
│  Autor: author@example.com           [ADMIN ONLY]  │
│                                        ↑ NEW        │
│  ┌───────────────────────────────────────────────┐ │
│  │ Conteúdo Atual                                 │ │
│  ├───────────────────────────────────────────────┤ │
...
✅ Email is selectable for copying
...
### Test Cases Added
1. **Admin sees email**: Verifies admin users can see the author email
2. **Non-admin doesn't see email**: Verifies non-admin users cannot see the email

### Test Results
```
✓ src/tests/pages/admin/documents/DocumentView.test.tsx (4 tests)
  ✓ should display document not found message
  ✓ should render back button in document view
  ✓ should display author email for admin users     ← NEW
  ✓ should not display author email for non-admin users ← NEW
```
